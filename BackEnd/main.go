...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	// Read parameter from request  get url, post -- body
	...
	fmt.Println("Rnage is ", ran)

	// Read post from Elasticsearch
	...
	// Convet read result to JSON and put it in the response
